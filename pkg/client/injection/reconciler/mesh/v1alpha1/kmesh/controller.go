...
import (
	...
	kmesh "knative.dev/kmesh/pkg/client/injection/informers/mesh/v1alpha1/kmesh"
...
const (
	defaultControllerAgentName = "kmesh-controller"
	defaultFinalizerName       = "kmeshes.mesh.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	kmeshInformer := kmesh.Get(ctx)

	lister := kmeshInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "mesh.knative.dev.KMesh"),
	)

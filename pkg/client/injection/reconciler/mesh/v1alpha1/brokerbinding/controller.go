...
import (
	...
	versionedscheme "knative.dev/kmesh/pkg/client/clientset/versioned/scheme"
	client "knative.dev/kmesh/pkg/client/injection/client"
	brokerbinding "knative.dev/kmesh/pkg/client/injection/informers/mesh/v1alpha1/brokerbinding"
...
const (
	defaultControllerAgentName = "brokerbinding-controller"
	defaultFinalizerName       = "brokerbindings.mesh.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	brokerbindingInformer := brokerbinding.Get(ctx)

	lister := brokerbindingInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "mesh.knative.dev.BrokerBinding"),
	)
